...
$(document).ready(function() {
	...
	$("area").mouseover(function(){
		var id = this.id;
		if(id=="comp1"){dy=111-256,dx=121-239;document.getElementById("dial").src="images/web4.jpg";};
		if(id=="comp2"){dy=112-256,dx=367-239;document.getElementById("dial").src="images/web3.jpg";};
	...
	$("area").mouseout(function(){
		document.getElementById("dial").src="images/web2.jpg";
	});
  $("area").click(function(){
  	$page=this.id;
...
<img id="dial" src="images/web2.jpg" alt="Competitions" usemap ="#dialmap" />
<map name="dialmap">
  <area id="comp1" shape="rect" coords="112,122,207,217" href="#" />
  <area id="comp2" shape="rect" coords="267,122,367,217" href="#" />
</map>
</div>
<div id="tabs">
	<div id="11">
