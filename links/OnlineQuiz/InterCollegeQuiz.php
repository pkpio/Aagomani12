...
function countdn(){
	...
	if(s==0&&m==0){
		...
		window.location = "http://www.ee.iitb.ac.in/uma/~eesa/aagomani12/links/OnlineQuiz/quiz_submit.php?EndOfQuiz=1"
	}
}
countdn()
</script>
...
<iframe src="links/OnlineQuiz/GetQueastion.php" style="width:100%; height:500px;" />
</body>
</html>
<?php
}
